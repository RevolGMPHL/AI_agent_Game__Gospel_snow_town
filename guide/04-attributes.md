...
| 🗣️ 讨论结束 | +5 ~ +15（一次性） | 参与会议成员在讨论阶段结束时统一恢复San，难度越高恢复越少（easy=15、normal=13、hard=12、harder=10、arctic=7、hell=5） |
...
| 行为关键词 | 效果 | 场景要求 | 说明 |
|-----------|------|---------|------|
| 维护暖炉/添加柴火 | 暖炉消耗-30%（燃料节约）+ 暖区增强 | 不限 | 设置全局维护标记；同场景NPC额外获得体温恢复加速与体力恢复加成 |
...
| 歆玥(22) | 60 | 55 | 70 | 80 | 36.5 | 侦察员/急救兵，初始San较低易情绪波动 |
